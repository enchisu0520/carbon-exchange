    ...
    >
        ...
        >
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-xl font-bold">{{ $t("price") }}</h2>
                <button
                    class="text-gray-500 hover:text-gray-900"
                    @click="$emit('closeMobilePriceFilter')"
                >
                    <svg
...
export default defineComponent({
    ...
    props: {
        isMobilePriceFilterOpen: Boolean,
        closeMobilePriceFilter: Function,
    },
    setup(props, { emit }) {
